...
<label for  "delEquipmentId"> EquipmentID </label>
<input type = "number" name = "delEquipmentId" id = "delEquipmentId" disabled>

<label for  "delEquipmentTypeID">EquipmentTypeID</label>
<input type = "number" name = "delEquipmentTypeID" id = "delEquipmentTypeID"   disabled>

<label for  "delDescription">Description</label>
<input type = "text" name = "delDescription" id = "delDescription"  disabled>

<label for  "delTimeOfPurchase">Time OF Purchase</label>
<input type = "date" name = "delTimeOfPurchase" id = "delTimeOfPurchase" title = "format is dd-mm-yyyy" disabled>

<label for  "delCost">Cost</label>
<input type = "number" name = "delCost" id = "delCost" disabled>

<label for  "delECondition"> Condition </label>
<input type = "text" name = "delECondition" id = "delECondition" disabled>
