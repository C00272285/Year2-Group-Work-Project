...
<label for  "amendEquipmentId"> EquipmentID </label>
<input type = "number" name = "amendEquipmentId" id = "amendEquipmentId" disabled>

<label for  "amendEquipmentTypeID">EquipmentTypeID</label>
<input type = "number" name = "amendEquipmentTypeID" id = "amendEquipmentTypeID"   disabled>

<label for  "amendDescription">Description</label>
<input type = "text" name = "amendDescription" id = "amendDescription"  disabled>

<label for  "amendTOP">Time OF Purchase</label>
<input type = "date" name = "amendTOP" id = "amendTOP" title = "format is dd-mm-yyyy" disabled>

<label for  "amendCost">Cost</label>
<input type = "number" name = "amendCost" id = "amendCost" disabled>

<label for  "amendECondition"> Condition </label>
<input type = "text" name = "amendECondition" id = "amendECondition" disabled>
